...
//
// UPDATE FOR WS2812 LEDs.
// Support for WS2812 LEDs implemented , with the need of 1 library. The Library you need to install is named: AdaFruit NeoPixel
// Without the library, you will receive an error message :)
// Have fun, playing with the "onewire" LEDs.
// As you see in the code, it is implemented in the "mid" position. Feel free to midify.
// now - let´s blink :)
//
// DM4DS - Sandor
//
// Link for the rc-network thread: https://www.rc-network.de/threads/openlight-unilight-in-eigenbau.11972603/
// Here´s the code:
...
pixels.setPixelColor(1, pixels.Color(255,255,255)); // WS2812 LED 1 green full power 255
pixels.setPixelColor(2, pixels.Color(255,255,255)); // WS2812 LED 2 green full power 255
pixels.setPixelColor(3, pixels.Color(255,255,255)); // WS2812 LED 3 green full power 255
...
pixels.setPixelColor(1, pixels.Color(255,0,0)); // WS2812 LED 1 green full power 255
pixels.show(); // send the "command" to the WS2812 LEDs
delay (ws2812time5); // Pause we defind earlier between each LED to light up
pixels.setPixelColor(2, pixels.Color(200,100,0)); // WS2812 LED 2 green full power 255
pixels.show();
delay (ws2812time5);
pixels.setPixelColor(3, pixels.Color(100,255,0)); // WS2812 LED 3 green full power 255
pixels.show(); 
delay (ws2812time5); 
pixels.setPixelColor(4, pixels.Color(0,255,0)); 
pixels.show();
delay (ws2812time5);
pixels.setPixelColor(5, pixels.Color(0,255,100));
pixels.show();
delay (ws2812time5);
pixels.setPixelColor(6, pixels.Color(0,200,200));
pixels.show();
delay (ws2812time5);
pixels.setPixelColor(7, pixels.Color(0,100,200));
pixels.show();
delay (ws2812time5);
